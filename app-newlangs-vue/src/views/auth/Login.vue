            ...
            <div
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    <div class="text-center mb-5">
                        ...
                        <span class="text-600 font-medium">Log in to your account</span>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex align-items-center justify-content-between mb-5 gap-5">
                            ...
                            <router-link to="/auth/register" class="font-medium no-underline ml-2 text-right cursor-pointer"
                                style="color: var(--primary-color)">Don't have an account? Register here</router-link>
                        </div>
                        <Button label="Log in" class="w-full p-3 text-xl" @click="login" :disabled="disabled"></Button>
                    </div>
                </div>
            </div>
        </div>
